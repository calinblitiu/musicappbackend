<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-tachometer" aria-hidden="true"></i>Add New Sync8
      </h1>
    </section>
           ...
           <div class="col-md-8">
           		<div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Sync8 Details</h3>
                    </div><!-- /.box-header -->

                     <form role="form" id="addSampleSet" action="<?php echo base_url() ?>index.php/addnewsync8_b" method="post" role="form" enctype='multipart/form-data'>
