<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-tachometer" aria-hidden="true"></i> Triggerz Sync8 List
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php/addnewsync8"><i class="fa fa-plus"></i> Add New Sync4</a>  
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Triggerz Sync8 List</h3>
                    <div class="box-tools">
                  ...
                  <table class="table table-hover">
                    ...
                    <?php for($i = 1; $i<=count($samples); $i++)
                    {
                      ...
                      <th class="text-center">
                        <a class="btn btn-sm btn-success" href="<?=base_url()?>index.php/editsync8-id/<?=$sample['id']?>" alt="edit sample"><i class="fa fa-pencil"></i></a>
                        <a class="btn btn-sm btn-info" href="<?=base_url()?>index.php/editsync8/<?=$sample['id']?>" alt="view sample set"><i class="fa fa-table"></i></a>
